...
class MTask{
		...
		*/
		public function finished(){
			echo 'finishNum:'.$this->finishNum.', tasksum:'.$this->taskNum.'<br>';
			return !($this->activeNum || $this->queueNum || !empty($this->taskFailed) || !empty($this->taskRunning) || !empty($this->taskPool));
        ...
        * running infomation
        */
        public function status($debug=false){
                if($debug){
        ...
        */
        public function add($url=array(),$p=array(),$f=array()){
                //check
        ...
        */
        function go(){
                ...
                if($running)
                        user_error('MTask can only run one instance',E_USER_ERROR);
